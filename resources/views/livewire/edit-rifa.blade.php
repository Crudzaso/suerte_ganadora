@role('admin')    
    ...
    <div class="flex flex-col justify-center items-center min-h-screen bg-gray-50">
        <!-- Título de la vista -->
        <h2 class="text-4xl font-bold mb-10 text-gray-800">Editar Rifa</h2>

        <!-- Formulario de edición -->
        <form wire:submit.prevent="update" class="w-full max-w-lg space-y-6 px-6">
            <!-- Campo Título -->
            ...
            <div class="flex justify-center">
                <button type="submit"
                        class="w-full h-16 bg-blue-600 text-white text-lg font-semibold rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Actualizar Rifa
                </button>
            </div>
        </form>
