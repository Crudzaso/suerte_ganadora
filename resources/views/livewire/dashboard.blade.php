        ...
        <div class="card">
            <div class="mb-18">
                <div class="card-body p-lg-17">
                    <!-- Header -->
                    <div class=" justify-between items-center bg-indigo-600 text-whiflexte p-6 rounded-lg shadow-md mb-10">
                        <h1 class="text-4xl font-extrabold">Bienvenido a <span class="text-yellow-400">Suerte Ganadora</span></h1>
                    </div>

                    <!-- Welcome Banner -->
                    <div class="bg-gradient-to-r from-teal-500 to-teal-400 rounded-lg p-8 mb-10 shadow-md">
